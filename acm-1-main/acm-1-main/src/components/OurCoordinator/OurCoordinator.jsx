...
{/* switch */}
        <div className={styles.switch}>
            ...
            <div className={styles.imageContainer}>
                    ...
                    <img className={styles.image__img}  src="https://media-exp1.licdn.com/dms/image/C5603AQH-3vDsIiwGCw/profile-displayphoto-shrink_800_800/0/1641002967570?e=1671667200&v=beta&t=MN_OHxWrRcRmAjgsTwCZV0IWpt5JonvGoxapWChTED8" alt="Yagnesh" />
                </div>
                <div className={`${styles.image__overlay} ${styles.image__overlay__primary}`}>
